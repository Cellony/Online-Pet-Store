    ...
    if(x=="Logout"){
        ...
        <header>
          ...
          <ul>
            ...
            <li><a href="../shop/shop.php" target="pg"><i class="material-icons" style="font-size:28px;">local_mall</i>Shop</a></li>
            <li><a href="../service/service.html" target="pg"><i class="material-icons" style="font-size:28px;">pets</i>Services</a></li>
